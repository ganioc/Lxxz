...
/*    public static OfflineFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBtnRefresh = (FloatingActionButton)view.findViewById(R.id.btnFabRefresh);
        mBtnRefresh.setOnClickListener(this);

        TextView txtView = (TextView)view.findViewById(R.id.txtOfflineHeader);
        CharSequence s = txtView.getText();
        SpannableString ss = new SpannableString(s);
        ss.setSpan(new RelativeSizeSpan(2f), 0,2,0);
        txtView.setText(ss);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnFabRefresh:
                Log.d(TAG, "btn Refresh");
                mListener.disableCheckNetworkAvailability();

                mListener.onFragmentOfflineRefresh(null);
            default:
                break;
        }
    }
    ...
    public interface OnFragmentOfflineListener {
        ...
        void onFragmentOfflineRefresh(Uri uri);
        void disableCheckNetworkAvailability();
